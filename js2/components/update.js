define(['./component', './data', 'context', 'primitives', 'stateMachine', 'input', 'events'], function(component, dataComponents, context, primitives, states, input, eventsModel){
    class UpdateComponent extends component.Component{
    ...
    class RotateCamera extends UpdateComponent{
        constructor(){
            super();
    ...
    class Controller extends UpdateComponent{
        constructor(){
            super();
    ...
    class Movement extends UpdateComponent{
        constructor(speed){
            super();
            this.speed = speed;
    ...
    class Spin extends  UpdateComponent{
        constructor(a, b, g){
            super();
