define(['./component', './data', './preRendering', 'render', 'primitives'], function(component, dataComponents, preRenderingComponents, render, primitives){
    class RenderingComponent extends component.Component{
