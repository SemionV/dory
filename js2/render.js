...
export class PointPrimitive extends DrawPrimitive{
...
export class Polygon extends DrawPrimitive{
...
export class Label extends PointPrimitive{
...
export class Point extends PointPrimitive{
...
export class Sprite extends PointPrimitive{
...
export class Canvas2DIsometricRenderer{
